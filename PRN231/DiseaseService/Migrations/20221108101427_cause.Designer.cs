...
namespace DiseaseService.Migrations
{
    ...
    [Migration("20221108101427_cause")]
    partial class cause
    {
            ...
            modelBuilder.Entity("DiseaseService.Models.Disease", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 867, DateTimeKind.Utc).AddTicks(9737),
                            ...
                            Name = "Powdery Mildew",
                            Status = true,
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 867, DateTimeKind.Utc).AddTicks(9950)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 868, DateTimeKind.Utc).AddTicks(111),
                            ...
                            Name = "Leaf Spot",
                            Status = true,
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 868, DateTimeKind.Utc).AddTicks(112)
                        });
                });
            ...
            modelBuilder.Entity("DiseaseService.Models.Symptom", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(725),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(743)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(745),
                            Description = "Purple reddish blotches appear on the upper and lower surface of leaves.",
                            Status = true,
                            Title = "Purple reddish blotches",
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(746)
                        },
                        new
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(747),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(748)
                        },
                        new
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(750),
                            Description = "Infected immature fruits become hardened and desiccated",
                            Status = true,
                            Title = "Infected immature fruits",
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(750)
                        },
                        new
                        {
                            Id = 5L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(752),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(753)
                        },
                        new
                        {
                            Id = 6L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(754),
                            ...
                            Status = true,
                            Title = "Leaves",
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(755)
                        },
                        new
                        {
                            Id = 7L,
                            CreatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(756),
                            ...
                            Status = true,
                            Title = "Young leaves",
                            UpdatedAt = new DateTime(2022, 11, 8, 10, 14, 26, 869, DateTimeKind.Utc).AddTicks(757)
                        });
                });
